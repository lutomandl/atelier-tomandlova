...
<style>
    ...
    div.burger-button.menuOpened {
        left: 240px;
    }

    div.burger-button > img {
        width: 24px;
        position: relative;
        top: 28px;
        left: 28px;
...
<div class="backdrop" class:menuOpened on:click={toggleMenu} />